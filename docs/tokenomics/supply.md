...
=== "Community Grants"
    **2,500,020,000 $EXPL**
    ...
    Funding for community projects and ecosystem growth initiatives

=== "Developer Incentives"
    **1,250,010,000 $EXPL**
    
    Bounties and rewards for developers building on explorills
...
=== "Liquidity Mining"
    **7,500,060,000 $EXPL**
    ...
    Rewards for liquidity providers in the explorills ecosystem

=== "Impermanent Loss Protection"
    **3,750,030,000 $EXPL**
    
    Protection mechanism for liquidity providers against impermanent loss

=== "HUB-Verified User"
    **1,250,010,000 $EXPL**
    
    Rewards for verified users in the explorills HUB
...
=== "Mystery-Box"
    **12,500,100 $EXPL**
    ...
    Community engagement prizes through Discord Mystery-Box
    
    Open once every 7 days for various rewards
...
-   :material-chart-donut:{ .lg .middle } **Total Supply**
...
-   :material-server-network:{ .lg .middle } **Node-Based**
