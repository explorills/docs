...
<div style="text-align: center; margin: 40px 0;">
  <figure style="display: inline-block;">
    <img src="../../assets/images/distroMasterMap.png" alt="$EXPL Distribution Master Map" style="max-width: 100%; height: auto;" />
    <figcaption><em>$EXPL Distribution Master Map</em></figcaption>
  </figure>
</div>
